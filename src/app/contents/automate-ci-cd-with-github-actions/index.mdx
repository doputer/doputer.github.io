...
[Knoticle](https://github.com/boostcampwm-2022/web01-knoticle) 서비스를 개발하면서 GitHub Actions로 CI/CD를 구성한 경험을 공유해보겠습니다.
...
- Lighthouse 지표 외에 다른 지표인 구글 [PageSpeed Insights](https://pagespeed.web.dev/)를 적용해볼 수 있습니다. 이곳에서는 웹 페이지에서 사용자의 환경 품질에 대한 평가 점수를 제공합니다.
